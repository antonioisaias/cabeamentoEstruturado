...
\postauthor{\footnotesize \usefont{OT1}{phv}{m}{sl} \color{Black} 
	                \\CERC04 - Cabeamento Estruturado - Redes VIII
	                \\Professor Doutor Alexandre L’Erario
	                \\Curso de Especilização em Redes de Computadores
...
\section{Risco}
Atraso na instalação ou indisponibilidade de links de dados por parte das operadoras de telefonia podem afetar a disponibilidade de internet aos usuários ou comprometer a redundância no acesso.
